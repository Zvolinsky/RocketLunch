...
{
    /// <inheritdoc />
    public partial class PierwszaNigracja : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dishes_Caterings_CateringId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDishs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderDishs_Dishes_DishId",
                        column: x => x.DishId,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderDishs_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dishes_CateringId",
                table: "Dishes",
                column: "CateringId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderDishs_DishId",
                table: "OrderDishs",
                column: "DishId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderDishs_OrderId",
                table: "OrderDishs",
                column: "OrderId");
